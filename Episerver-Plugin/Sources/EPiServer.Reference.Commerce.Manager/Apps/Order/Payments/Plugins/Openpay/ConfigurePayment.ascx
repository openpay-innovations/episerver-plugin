...
<div id="DataForm">
    <table cellpadding="0" cellspacing="2">
        <tr>
            <td class="FormLabelCell" colspan="2">
                <b>
                    <asp:Literal ID="Literal1" runat="server" Text="Configure Openpay" /></b>
            </td>
        </tr>
    </table>
    <br />
    <b><asp:Literal ID="ErrorMessage" runat="server"  Text=""/></b>
    <table class="DataForm">
        ...
        <tr>
            ...
            <td class="FormFieldCell">
                <asp:RadioButtonList ID="Environment" runat="server">
                </asp:RadioButtonList>
        ...
        <tr>
            <td class="FormLabelCell">
                <asp:Literal ID="Literal6" runat="server" Text="Minimum Purchase Limit" /> :</td>
            <td class="FormFieldCell">
